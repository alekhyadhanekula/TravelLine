...
<div class="container">
  <h2>Modify Bus Service</h2> 
  </br>
  <form class="form-inline" action="ModifyServiceServlet" autocomplete="off" method="post">
    <div class="form-group">
      <label for="serviceno">Service No:</label></br>
      <input type="text" class="form-control" id="serviceno" placeholder="Enter number" name="serviceno" requried size="20">&nbsp;&nbsp;&nbsp;
    </div></br></br>
    <div class="form-group">
      <label for="source">Source:</label></br>
      <input type="text" class="form-control" id="source" placeholder="Enter source" name="source" requried size="20">&nbsp;&nbsp;&nbsp;
    </div>
    <div class="form-group">
      <label for="destination">Destination:</label></br>
      <input type="text" class="form-control" id="destination" placeholder="Enter destination" name="destination" requried size="20">&nbsp;
    </div>
    </br></br></br>
    <div class="form-group">
      <label for="source">Start Time:</label></br>
      <input type="text" class="form-control" id="start" placeholder="Enter departure time" name="start" requried size="20">&nbsp;&nbsp;
    </div>
    <div class="form-group">
      <label for="end">End Time:</label></br>
      <input type="text" class="form-control" id="end" placeholder="Enter end time" name="end" requried size="20">&nbsp;&nbsp;&nbsp;
    </div>
  </br></br></br>
   <div class="form-group">
